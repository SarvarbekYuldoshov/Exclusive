...
const Korzinka = () => {
    ...
    return (
        <>
            <Bollen />
            <Header />
            <div className='max-w-[1200px] mx-auto p-4 mt-[50px]'>
                <h1 className='text-[30px] text-center mb-[40px]'>Bu yerda sizga kerakli mahsulotlar mavjud</h1>
                {single.map(item => (
                        ...
                        <div className='w-full lg:w-[200px] h-auto lg:h-[600px]'>
                            {item.images.map((img, index) => (
                                <React.Fragment key={index}>
                                    <img className='w-[100px] h-[100px] mx-auto mt-[10px]' src={img} alt={item.name} />
                                    {index < item.images.length - 1 && <hr className='mt-[10px] h-[3px] bg-black' />}
                                </React.Fragment>
                            ))}
                        </div>
                        <div className='flex flex-col lg:flex-row items-center lg:items-start w-full'>
                            ...
                            <div className='text-center lg:text-left lg:ml-6'>
                                ...
                                <Modal open={open} footer={null} onCancel={closeModal}>
                                    <h1 className='text-[30px] text-center'>Ma'lumotlarni to'ldiring</h1>
                                    <p className='text-[20px] text-center text-blue-500'>Biz siz bilan imkon qadar tez bog'lanamiz va sizning mahsulotingizni yetkazib beramiz. Xizmatimiz bepul!</p>
