    ...
    <div className='bg-black text-center'>
      <div className='flex flex-col md:flex-row items-center mx-auto max-w-[1200px] p-6 md:p-10'>
        <ul className='md:mr-10 text-white'>
          ...
          <h1 className='mt-[30px] font-inter w-full md:w-[500px] h-auto text-[36px] md:text-[48px] font-semibold leading-[40px] md:leading-[60px] tracking-wide text-left max-sm:text-[50px]'>
            Up to 10% off Voucher
          </h1>
          <button className='flex items-center mt-10 md:mt-20 w-[150px] h-[40px] gap-5 border border-white hover:scale-105 transition-transform duration-300 max-sm:ml-5'>
