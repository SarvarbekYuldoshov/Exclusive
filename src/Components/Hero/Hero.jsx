    ...
    <div className='bg-black text-center'>
      <div className=' mt-20 flex flex-col md:flex-row items-center mx-auto max-w-[1200px] p-6 md:p-10'>
        <ul className='md:mr-10 text-white'>
          ...
          <h1 className='mt-[20px] font-inter w-[320px] h-[230px]  text-[36px] md:text-[48px]  font-semibold leading-[40px] md:leading-[60px] tracking-wide text-left max-sm:text-[40px] w-[140px] h-[160px]'>
            Up to 10% off Voucher
           </h1>
          <button className='flex items-center w-[150px] h-[40px] gap-5 mt-[20px] border border-white hover:scale-105 transition-transform duration-300 max-sm:ml-7'>
