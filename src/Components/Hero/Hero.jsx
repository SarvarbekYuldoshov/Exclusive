...
const Hero = () => {
  return (
    <div className=' bg-black'>
      <div className='text-center justify-center flex mx-auto max-w-[1200px]'>
        <ul className=''>
            <li className='flex items-center gap-5' my-40>
            ...
            <h1 className='font-inter text-[48px] font-semibold leading-[60px] tracking-[0.04em] text-left text-[#FAFAFA] w-[294px] h-[120px]'>Up to 10% off Voucher</h1>
